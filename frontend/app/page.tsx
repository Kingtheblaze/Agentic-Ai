...
const QUICK_PROMPTS = [
  {
    ...
    label: "Uploaded Docs",
    prompt:
      "Summarize the key skills, education, and project experience from the uploaded Sambhav Heda resume.",
  },
  {
    icon: GraduationCap,
    label: "Course Info",
  ...
  },
  {
    ...
    label: "Account Help",
    prompt:
      "I'm locked out of my university email account and have an assignment due tonight.",
  },
];
...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <main ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-6 md:px-8">
          ...
          {messages.length === 0 ? (
            <div className="flex min-h-[60vh] flex-col items-center justify-center animate-fade-in">
              ...
              <p className="mb-8 max-w-md text-center text-sm text-slate-400">
                ...
                uploaded documents, course policies, or IT issues from one
                shared assistant.
              </p>
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                <div className="flex items-center gap-2 rounded-full border border-brand-500/20 bg-brand-500/5 px-4 py-2">
                  ...
                  <span className="text-xs text-brand-300">Knowledge Agent</span>
                </div>
      ...
      <div className="border-t border-white/5 bg-surface-900/80 px-4 py-4 backdrop-blur-xl md:px-8">
        <form
        ...
        >
          <div className="relative flex-1">
            <input
              ...
              placeholder="Ask about uploaded PDFs, department policies, or report an IT issue..."
